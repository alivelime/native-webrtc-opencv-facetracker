...
context_ptr on_tls_init(tls_mode mode, websocketpp::connection_hdl hdl) {
    ...
    try {
        ...
        ctx->use_certificate_chain_file("/home/cal92re/ssl/aisatsu.tk.crt");
        ctx->use_private_key_file("/home/cal92re/ssl/aisatsu.tk.key", asio::ssl::context::pem);
...
//        ctx->use_tmp_dh_file("dh.pem");
    ...
    std::cout << "ssl init end." << std::endl;
    return ctx;
}

WebsocketServer* ServerInit(
    std::function<void(WebsocketServer*, websocketpp::connection_hdl)> con_callback,
